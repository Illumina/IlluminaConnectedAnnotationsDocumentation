...
1. Invalid Ref Allele: eg `VCV000437934`
2. Invalid Alt Allele: eg `VCV000006637`
3. Following variant types are not supported:
    1. `Variation`: eg `VCV000001101`
    2. `fusion`: eg `VCV000015269`
    3. `unknown`: eg `VCV000017564`
    4. `protein only`: eg `VCV000132152`
    5. `Complex`: eg `VCV000221337`
    6. `Translocation`: eg `VCV000267801`
    7. `no_sequence_alteration`: eg `VCV000010504`
4. Only records of type `classified` are included [VCV with type `included` is skipped: eg `VCV000431749`]
5. Records with missing genomic location are skipped: eg `VCV000000254`
:::
