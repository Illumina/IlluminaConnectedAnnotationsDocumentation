...
Promoter region is described as 5000 nt upstream of a transcript transcription starting site (TSS). Each annotation will show score of teh variant and which transcript and which gene is the promoter region correspond to.
