...
:::info
DataManager utility requires credential file to be generated first. Please follow the guide to generate this file from getting started page.
:::
