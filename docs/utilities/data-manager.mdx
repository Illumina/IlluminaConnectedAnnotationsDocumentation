...
* corresponding to version config files [all_annotations_GRCh37.json](resources/all_annotations_GRCh37.txt) and [all_annotations_GRCh38.json](resources/all_annotations_GRCh38.txt). 
