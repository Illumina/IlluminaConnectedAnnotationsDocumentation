...
* <path_to_checksum_file> is the path to the corresponding checksum file (e.g., [checksumGRCh37.txt](../introduction/checksumGRCh37.txt) or [checksumGRCh38.txt](../introduction/checksumGRCh38.txt))
