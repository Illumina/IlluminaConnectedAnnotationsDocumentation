...
For GRCh38, our latest reference genome is using version GRCh38.p14. The list of chromosome and contigs in this version can be checked from this [file](https://ftp.ncbi.nlm.nih.gov/genomes/all/annotation_releases/9606/GCF_000001405.40-RS_2023_10/GCF_000001405.40_GRCh38.p14_assembly_report.txt)
:::caution
